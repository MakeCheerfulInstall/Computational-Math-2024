...
import Computational.Math.GraphicPart.FunctionsComponents.ArrayDrawer.ArraysDrawer;
...
public class MainFrame extends JFrame {
    ...
    public static void drawArrays(String methodName, ArrayList<Double> xList,ArrayList<Double> list1, ArrayList<Double> list2,ArrayList<Double> list3,ArrayList<Double> correctList,int numXTicks,int numYTicks){
        EventQueue.invokeLater(()->{
            MainFrame frame = MainFrame.getFrame(methodName);
            // Создаем Axes и SystemFunctionPainterComponent
            Axes axes = new Axes(numXTicks,numYTicks);
//            SystemFunctionPainterComponent systemDrawer = new SystemFunctionPainterComponent(listOfFunctions);
            ArraysDrawer arraysDrawer = new ArraysDrawer(xList,list1,list2,list3,correctList);
