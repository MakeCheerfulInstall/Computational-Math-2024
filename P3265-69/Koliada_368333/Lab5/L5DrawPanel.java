 ...
 */
public class L5DrawPanel extends JPanel {
    public L5DrawPanel() {
    ...
    private void drawGrafic(Graphics2D g) {
        ...
        for(IFunction fun:_function) {
            try {
                ...
                g.drawString(fun.toString(), 45, iCount * 15 + 10);
            }
            catch (CalcErrorException e){
                g.drawString(fun.toString() + " " + e.getMessage(), 5, iCount * 15 + 10);
            }
        }
    }
