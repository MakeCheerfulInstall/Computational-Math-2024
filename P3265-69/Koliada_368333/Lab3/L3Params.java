...
public class L3Params {
     ...
     * Калькулятор всего
     */
    private L3CalculationProcess _calculation = null;
    /**
     ...
     */
    public void setCalcProcess(L3CalculationProcess prc) {
        _calculation = prc;
    }
    ...
    private void initComboboxes() {
        ...
        funCombo.addItem(new SFunction4());
        funCombo.addItem(new SFunction5());
        funCombo.addItem(new SFunction6());
