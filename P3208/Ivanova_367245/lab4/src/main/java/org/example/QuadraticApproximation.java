...
public class QuadraticApproximation {
    ...
    public double [] solve(double [] x, double[] y, int amount){
        ...
        a0 = (sy * sxx * sxxxx + sxxy*sx*sxxx + sxy*sxx*sxxx - sxxy * sxx * sxx - sx*sxy*sxxxx - sy*sxxx*sxxx)/(amount*sxx*sxxxx+sx*sxx*sxxx+sxx*sx*sxxx - sxx*sxx*sxx - sx * sx * sxxxx- amount*sxxx*sxxx);
        a1 = (amount*sxy*sxxxx+sx*sxx*sxxy+sxx*sy*sxxx-sxx*sxy*sxx - sx*sy*sxxxx - amount*sxxy*sxxx)/(amount*sxx*sxxxx+sx*sxx*sxxx+sxx*sx*sxxx - sxx*sxx*sxx - sx * sx * sxxxx- amount*sxxx*sxxx);
        a2 = (amount*sxx*sxxy+sx*sy*sxxx+sxx*sx*sxy - sxx*sxx*sy - sx*sx*sxxy - amount*sxxx*sxy)/(amount*sxx*sxxxx+sx*sxx*sxxx+sxx*sx*sxxx - sxx*sxx*sxx - sx * sx * sxxxx- amount*sxxx*sxxx);
