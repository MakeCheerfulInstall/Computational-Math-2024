...
import lab2.corrections.SystemSimpleIterationRefinement;
import lab2.corrections.Value;
import lab2.equations.Equation;
import lab2.solvers.NonlinearEquationSolver;
import lab2.solvers.NonlinearSystemSolver;
...
public class NonlinearEquationsApplication {
  ...
  private static void draw(Equation e, double[] line) {
    EventQueue.invokeLater(
        () -> {
          Graph demo = new Graph(e, line, "График функции");
          demo.pack();
